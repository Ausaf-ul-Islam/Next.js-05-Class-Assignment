    ...
    <div className="flex items-center justify-center p-8 md:p-16 bg-white">
      <div className="flex flex-col md:flex-row items-center max-w-6xl mx-auto md:space-x-16 space-y-8 md:space-y-0">
        ...
        <div className="flex flex-col space-y-4 max-w-md text-center md:text-left">
          ...
          >
            IMPECCABLE <br className="hidden md:block" /> CRAFTSMANSHIP AND <br className="hidden md:block" /> FINESSE
          </h1>
          <p
        ...
        <div className="relative flex justify-center">
          ...
          <div className="absolute top-2 md:top-4 left-2 md:left-4 w-[260px] h-[360px] md:w-[380px] md:h-[525px] border-[1.5px] md:border-[2px] border-gray-300 rounded-tl-[80px] rounded-br-[80px] md:rounded-tl-[120px] md:rounded-br-[120px]" />
        </div>
      </div>
    </div>
  );
